...
> Retrieve a single stub mapping by ID.



## OpenAPI

````yaml /api-reference/openapi.yaml get /v1/mock-apis/{mockApiId}/mappings/{stubMappingId}
openapi: 3.1.0
info:
                    ...
                    parameters:
                      operations:
                        - operation: SET
                          ...
                          key: basketItems
                          value: >-
                            {{ jsonArrayAdd (val previousValue or='[]')
                            request.body }}
            Data Source:
              value:
                id: 76ada7b0-49ae-4229-91c4-396a36f18e09
