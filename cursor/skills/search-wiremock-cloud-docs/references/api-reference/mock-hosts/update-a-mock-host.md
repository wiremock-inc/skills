...
> Update a mock host's details.



## OpenAPI

````yaml /api-reference/openapi.yaml put /v1/hosts/{mockHostId}
openapi: 3.1.0
info:
              ...
              properties:
                mockHost:
                  ...
                  properties:
                    role:
                      description: >-
                        If DEFAULT, new Mock APIs will be automatically assigned
                        to this host if it has fewer than any other host with
                        role DEFAULT
                      type: string
                      enum:
                        - DEFAULT
