...
````yaml api-reference/openapi.yaml post /v1/mock-apis/{mockApiId}/mappings/import
openapi: 3.1.0
info:
  ...
  /v1/mock-apis/{mockApiId}/mappings/import:
    ...
    post:
      ...
      description: >
        ...
        Note: a more flexible import operation is available at the [Import
        endpoint](../imports/import).
